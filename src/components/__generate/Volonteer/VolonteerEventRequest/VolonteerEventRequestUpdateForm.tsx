...
import { InputParameters } from './VolonteerEventRequestUpdate';
...
export const VolonteerEventRequestUpdateForm: FC<FormProps> = ({ inputParameters, changeInputParameters }) => {
